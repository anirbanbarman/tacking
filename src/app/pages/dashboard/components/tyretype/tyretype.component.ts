...
export class TyretypeComponent implements OnInit,AfterViewInit {
  ...
  @ViewChild(MatSort) sort !: MatSort;
    ...
    { 
      ...
      this.getZones();
      this.getDataList();
      this.gettyretypemaxid();
      this.gettyretypeminid();
  ...
  getDataList()
  {
    ...
    getStateData(id:any) {
      ...
      gettyretypemaxid() {
        this.spinner.show();
        console.log("gettyretypemaxid");
        this.dashboardService.gettyretypemaxid().subscribe((response: any) => {      
          this.spinner.hide();
          console.log("gettyretypemaxid response->",response);
          if (response && response.status === 200 && response.data) {
            console.log(response);
      ...
      gettyretypeminid() {
        this.spinner.show();
        console.log("gettyretypeminid");
        this.dashboardService.gettyretypeminid().subscribe((response: any) => {      
          this.spinner.hide();
          console.log("gettyretypeminid response->",response);
          if (response && response.status === 200 && response.data) {
            console.log(response);
