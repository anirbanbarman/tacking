...
@Component({
  selector: 'app-broker-tab-two',
  templateUrl: './broker-tab-two.component.html',
  styleUrls: ['./broker-tab-two.component.scss']
})
export class BrokerTabTwoComponent implements OnInit {
  panimage: any = '';
  aadharimage: any = '';
